...
import { BreadcrumbFinishesSection } from "@/widgets/case-finishes/breadcrumbs-finishes"
...
import { FinishImageSection } from "@/widgets/finish-image"
...
export function CaseFinishesPage({ data }: CaseFinishesPageProps) {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Breadcrumb */}
      <BreadcrumbFinishesSection data={data} />
            ...
            {data.variations && (
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
                {data.variations.map((variantion, index) => (
                  ...
                  >
                    <h3 className="font-semibold text-black mb-2">{variantion.title}</h3>
                    <p className="text-sm text-gray-600">{variantion.description}</p>
                  </div>
                ))}
              </div>
            )}
