      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none">
            <div className="mb-16">
              <p className="font-sans text-gray-700 leading-relaxed mb-8 text-lg">
                In 1972, Ferdinand Alexander "Butzi" Porsche, the legendary designer of the Porsche
                911 and grandson of the company's founder, Ferdinand Porsche, launched Porsche
                Design as an independent studio specializing in industrial design. His first product
                wasn't a car or a piece of furniture; it was a wristwatch. But it wasn't just any
                timepiece: it was the world's first entirely blacked-out watch, a revolutionary
                departure from the shiny stainless steel and gold cases of the era. Built on the
                same design principles as the 911 - and inspired by its gauge cluster - this new
                chronograph marked the beginning of a new chapter in both watchmaking and design
                history. Ferdinand stated, "My idea was for the watch to match the design of the car
                - the 911 has a black speedometer and tachometer in order not to blind the driver."
              </p>
              <p className="font-sans text-gray-700 leading-relaxed mb-8 text-lg">
                To bring his vision to life, Butzi Porsche partnered with Umberto Maglioli, a former
                Porsche racing driver who had acquired the Swiss watch company Orfina. Their
                collaboration merged timeless automotive design with the rugged, purpose-built ethos
                of Swiss chronograph engineering. Initially powered by the Valjoux 7750 automatic
                movement, introduced in 1973 as Valjoux's late entry into the automatic chronograph
                race, Porsche Design and Orfina were forced to adapt when the quartz crisis
                disrupted mechanical watchmaking and shuttered Valjoux's production. They responded
                by switching to the Lemania 5100, a movement famed for its shock resistance and
                reliability. It was the only chronograph caliber at the time that could withstand
                vertical accelerations of up to 7 Gs without its central seconds hand halting or
                losing accuracy - a quality that made it a favorite among fighter pilots and
                military forces alike.
              </p>
              <p className="font-sans text-gray-700 leading-relaxed text-lg">
                The resulting watch wasn't just innovative in design - it was engineered for
                performance under extreme conditions. This synthesis of Porsche's design DNA and
                Orfina's mechanical grit gave rise to a cult classic: the Orfina Porsche Design
                Chronograph.
              </p>
            </div>
          </div>
