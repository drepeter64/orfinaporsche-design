...
const ExploreDetailsCard = ({
  ...
  return (
    ...
    >
      <div className="bg-[#f0f0eb] overflow-hidden transition-all duration-300 group-hover:-translate-y-2 p-4 flex flex-col gap-4 border-b-4 border-transparent group-hover:border-stone-300">
        {/* Image Container */}
