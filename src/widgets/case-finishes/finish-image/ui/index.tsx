  ...
  const renderImage = (img: ImageInfo) => (
    ...
    >
      ...
      <ImageWithLoader
        src={img.src || "https://pub-2402089ff2104077a64e15b6935f53e6.r2.dev/img/placeholder.png"}
        alt={img.alt}
        className={`relative object-cover rounded-lg shadow-lg group-hover:shadow-xl transition-all duration-300 group-hover:scale-105 ${img.imgClassName ?? "w-full h-64 sm:h-80 lg:h-96"}`}
